...
### 自定义 TabBar ✨新增
- **自定义组件** - 完全自定义底部导航栏
- **更大字号** - 16-18px（系统默认 10px）
- **选中效果** - 加粗 + 颜色变化 + 平滑过渡
- **喜庆配色** - 中国红背景 + 金黄色文字

### 摇一摇功能 ✨优化
- **加速度计监听** - wx.onAccelerometerChange
- **向量和算法** - 更准确的摇晃检测
- **防抖机制** - 3秒内只触发一次
- **震动反馈** - wx.vibrateShort 提升体验
